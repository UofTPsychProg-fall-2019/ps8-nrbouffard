...
#tbl_clean$gender <- tbl_clean$gender[which(is.na(tbl_clean$gender))] <- 'NA' # this didn't work
#tbl_clean$gender <- na_if(tbl_clean$gender, NA) # this didn't work
tbl_clean$gender <- fct_explicit_na(tbl_clean$gender)

#tbl_clean$state <- tbl_clean$state[which(is.na(tbl_clean$state))] <- 'NA' # this didn't work
